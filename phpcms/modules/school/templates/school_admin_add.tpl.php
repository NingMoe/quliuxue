...
<div class="pad-lr-10">
  ...
  <form action="?m=school&c=school&a=add&pc_hash=<?php echo $_SESSION['pc_hash'];?>" method="post" id="myform">
    ...
    <fieldset>
      ...
      <tr>
          ...
          <td class="y-bg"><input type="text" class="input-text"  name="dianji" id="dianji" height="30" size="30" />
      ...
      <tr>
          ...
          <td class="y-bg"><label class="ib" >
              ...
              <input type="radio" name='recommend' checked id="recommend_1"  value="0">

              默认</label>

            <label class="ib" >

              <input type="radio" name='recommend'  id="recommend_2"  value="1">
        ...
        <tr>
          ...
          <td class="y-bg"><label class="ib" >
              ...
              <input type="radio" name='country'  id="country_1"  value="1">

              美国</label>

            <label class="ib" >

              <input type="radio" name='country'  id="country_2"  value="2">

              英国</label>

            <label class="ib" >

              <input type="radio" name='country'  id="country_3"  value="3">

              加拿大</label>

            <label class="ib" >

              <input type="radio" name='country'  id="country_4"  value="4">

              澳大利亚</label>

            <label class="ib" >

              <input type="radio" name='country'  id="country_5"  value="5">

              新加坡</label>

            <label class="ib" >

              <input type="radio" name='country'  id="country_6"  value="6">
        ...
        <tr>
          ...
          <td class="y-bg"><input type="text" class="input-text"  name="cnname" id="cnname" height="30" size="30" />
        ...
        <tr>
          ...
          <td class="y-bg"><input type="text" class="input-text"  name="enname" id="enname" height="30" size="30" />
        ...
        <tr>
          ...
          <td class="y-bg"><script type="text/javascript" src="<?php echo APP_PATH;?>statics/js/swfupload/swf2ckeditor.js"></script>
            ...
            <input type='text' name='logo' id='logo' value='' size='' class='input-text' />
	...
	d.uploadfile();return false;}, function(){window.top.art.dialog({id:'crop'}).close()});
        ...
        <tr>
          ...
          <td class="y-bg"><input type="text" class="input-text"  name="location" id="location" height="30" size="30" />
        ...
        <tr>
          ...
          <td class="y-bg"><input type="text" class="input-text"  name="position" id="position" height="30" size="30" />
        ...
        <tr>
          ...
          <td class="y-bg"><input type="text" class="input-text"  name="rank" id="rank" height="30" size="30" />
        ...
        <tr>
          ...
          <td class="y-bg"><input type="text" class="input-text"  name="odds" id="odds" height="30" size="30" />
        ...
        <tr>
          ...
          <td class="y-bg"><input type="text" class="input-text"  name="weburl" id="weburl" height="30" size="30" />
        ...
        <tr>
          ...
          <td class="y-bg"><input type="text" class="input-text"  name="toefl_scores" id="toefl_scores" height="30" size="30" />
        ...
        <tr>
          ...
          <td class="y-bg"><input type="text" class="input-text"  name="ielts_score" id="ielts_score" height="30" size="30" />
        ...
        <tr>
          ...
          <td><input type="hidden" name='degree[]'  value="-99">

            <label class="ib" style="width:80px">

              <input type="checkbox" name='degree[]'  id="degree_1"  value="1">

              本科</label>

            <label class="ib" style="width:80px">

              <input type="checkbox" name='degree[]'  id="degree_2"  value="2">

              硕士</label>

            <label class="ib" style="width:80px">

              <input type="checkbox" name='degree[]'  id="degree_3"  value="3">

              博士</label>

            <label class="ib" style="width:80px">

              <input type="checkbox" name='degree[]'  id="degree_4"  value="4">
      ...
      <td><div id='school_profile_tip'></div><textarea name="school_profile" id="school_profile" boxid="school_profile"></textarea><script charset="utf-8" type="text/javascript" src="/statics/js/kindeditor/kindeditor-min.js"></script><script charset="utf-8" type="text/javascript" src="/statics/js/kindeditor/lang/zh_CN.js"></script><script type="text/javascript">
...
width : '99%',height : '400px'});});</script><table cellpadding='0' cellspacing='1' border='0'><tr><td></td></tr></table>  </td>
 ...
 <td><div id='requirements_tip'></div><textarea name="requirements" id="requirements" boxid="requirements"></textarea>
...
width : '99%',height : '400px'});});</script><table cellpadding='0' cellspacing='1' border='0'><tr><td></td></tr></table>  </td>
        ...
        <tr>
          ...
          <th width="120"> 七嘴八舌 </th>
           ...
           <td><div id='qizuibashe_tip'></div><textarea name="qizuibashe" id="qizuibashe" boxid="qizuibashe"></textarea>

		   <script type="text/javascript">

KindEditor.ready(function(K) {

editor = K.create('textarea[id="qizuibashe"]', {
...
width : '99%',height : '400px'});});</script><table cellpadding='0' cellspacing='1' border='0'><tr><td></td></tr></table>  </td>
        ...
        <tr>
          ...
          <th width="120"> 校园文化 </th>
           ...
           <td><div id='culture_tip'></div><textarea name="culture" id="culture" boxid="culture"></textarea>
...
width : '99%',height : '400px'});});</script><table cellpadding='0' cellspacing='1' border='0'><tr><td></td></tr></table>  </td>
    ...
    ?>
            ...
            <label class="ib" style="width:110px">
              ...
              <input type="checkbox" name='professional[]'  id="p_<?php echo $v_professional[id]?>"  value="<?php echo $v_direction[professional_id]?>">
