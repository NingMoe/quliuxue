...
<div class="pad-lr-10">
  ...
  <form action="?m=school&c=school&a=add_direction&pc_hash=<?php echo $_SESSION['pc_hash'];?>" method="post" id="myform">
    ...
    <fieldset>
      ...
      <table width="100%"  class="table_form">
        ...
        <th width="120">所属学校：</th>

          <td class="y-bg"><input type="text" class="input-text" value="<?php echo $_GET['id'];?>"  name="direction_school_id" readonly="readonly" id="direction_school_id" height="30" size="30" />
        ...
        <th width="120">专业排名：</th>
          ...
          <td class="y-bg"><input type="text" class="input-text"  name="direction_rank" id="direction_rank" height="30" size="30" />
        ...
        <th width="120">中文名称：</th>
          ...
          <td class="y-bg"><input type="text" class="input-text"  name="direction_cnname" id="direction_cnname" height="30" size="30" />
        ...
        <th width="120">英文名称：</th>
          ...
          <td class="y-bg"><input type="text" class="input-text"  name="direction_enname" id="direction_enname" height="30" size="30" />
        ...
        <th width="120">专业详情：</th>
          ...
          <td class="y-bg"><input type="text" class="input-text"  name="direction_weburl" id="direction_weburl" height="30" size="30" />
        ...
        <th width="120">学位类型：</th>
          ...
          <td class="y-bg"><input type="text" class="input-text"  name="direction_style" id="direction_style" height="30" size="30" />
...
width : '99%',height : '400px'});});</script><table cellpadding='0' cellspacing='1' border='0'><tr><td></td></tr></table>  </td>
    ...
    ?>
            <label class="ib" style="width:110px">
              <input type="radio" name='direction_pid' <?php if($r['direction_pid']==$v_professional ||$r['direction_pid']*100==$v_professional){echo "checked";}else{}?>   id="p_<?php echo $v_professional[id]?>"  value="<?php echo $v_professional;?>">
