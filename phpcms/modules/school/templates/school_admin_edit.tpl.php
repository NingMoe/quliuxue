...
}elseif(in_array(($v_direction['professional_id']/100),$people)){

  echo "checked";

}
elseif(in_array(($v_direction['professional_id']-10000),$people)){

  echo "checked";

}
elseif(in_array($v_direction['professional_id'],$people)){
...
?> 
               ...
               id="p_<?php echo $v_professional[id]?>"  value="<?php echo $v_direction[professional_id]?>">
