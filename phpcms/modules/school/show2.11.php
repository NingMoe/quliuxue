...
class show {
	...
	public function init() {                                               //默认方法		
        ...
        $rs_all = $list2->query("SELECT a.content,b.id,b.direction_cnname,b.direction_enname,b.direction_style FROM qu_professional_data a,qu_school_professional_data b where a.id=b.direction_pid  and b.direction_school_id='".$_GET[id]."'  ORDER BY b.id DESC");
    ...
    public function common($sid,$pid) {
        ...
        $list1=pc_base::load_model('professional_data_model');
		$list2=pc_base::load_model('school_professional_data_model');
		$rs = $list2->query("SELECT  a.content,b.id,b.direction_cnname,b.direction_enname,b.direction_style  FROM qu_professional_data a,qu_school_professional_data b where a.id=b.direction_pid and a.professional_pid='".$pid."' and b.direction_school_id='".$sid."'  ORDER BY b.id DESC");
    ...
    public function show_c() {
        ...
        $where3=array('id'=>$show2[direction_pid]);
