...
<style type="text/css">
	...
	.login_box{background:url(<?php echo IMG_PATH?>admin_img/login_bg.png) no-repeat; width:602px; height:416px; overflow:hidden; position:absolute; left:50%; top:50%; margin-left:-301px; margin-top:-208px;}
...
<div id="login_bg" class="login_box">
    ...
    <div class="cr">CopyRight 申友教育信息咨询（武汉）有限公司</div>
</div>
</body>
</html>